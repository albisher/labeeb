...
class SystemInfoGatherer:
    ...
    def _get_platform_info(self) -> Dict[str, str]:
        ...
        return {
            "system": platform_utils.get_platform_name(),
            "release": platform_utils.get_platform_release(),
            "version": platform_utils.get_platform_version(),
            "machine": platform_utils.get_platform_machine(),
            "processor": platform_utils.get_platform_processor(),
        }
