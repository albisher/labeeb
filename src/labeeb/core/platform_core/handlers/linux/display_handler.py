"""
Linux display handler for Labeeb.

Provides platform-specific display handling for Linux, including screen capture, display information, and RTL text detection.

---
description: Linux display handler
inputs: [action, display_id]
outputs: [image, displays, error]
dependencies: [PIL, pytesseract, Xlib]
alwaysApply: false
---
"""
...
class LinuxDisplayHandler(BaseHandler):
    """Handler for Linux display devices."""
    ...
    def initialize(self) -> bool:
        try:
            ...
            print(f"Failed to initialize LinuxDisplayHandler: {e}")
            return False
