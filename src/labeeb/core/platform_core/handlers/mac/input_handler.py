...
class MacInputHandler(BaseHandler):
    ...
    def _initialize_keyboard_layout(self) -> None:
        ...
        try:
            ...
            if source:
                self._keyboard_layout = Quartz.TISGetInputSourceProperty(
                    source, Quartz.kTISPropertyInputSourceID
                )
    ...
    def click_mouse(self, button: str = "left") -> bool:
        ...
        try:
            ...
            down_event = Quartz.CGEventCreateMouseEvent(
                None, Quartz.kCGEventLeftMouseDown, pos, button_code
            )
            Quartz.CGEventPost(Quartz.kCGHIDEventTap, down_event)

            # Create and post mouse up event
            up_event = Quartz.CGEventCreateMouseEvent(
                None, Quartz.kCGEventLeftMouseUp, pos, button_code
            )
    ...
    def _switch_to_arabic_layout(self) -> bool:
        ...
        try:
            ...
            for i in range(Quartz.CFArrayGetCount(input_sources)):
                ...
                source_id = Quartz.TISGetInputSourceProperty(
                    source, Quartz.kTISPropertyInputSourceID
                )
            ...
            if arabic_source:
                ...
                self._keyboard_layout = Quartz.TISGetInputSourceProperty(
                    arabic_source, Quartz.kTISPropertyInputSourceID
                )
                return True
