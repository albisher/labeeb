...
class MathTool(BaseTool):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(
            name="math", description="Tool for performing mathematical operations", config=config
        )
    ...
    async def _basic_operation(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_operation("basic", op=args["op"], a=args["a"], b=args["b"])
    ...
    async def _trigonometric_operation(
    ...
    async def _logarithmic_operation(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_operation(
                "logarithmic", func=args["func"], x=args["x"], base=args.get("base", math.e)
            )
    ...
    async def _statistical_operation(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_operation(
                "statistical", func=args["func"], data=args["data"]
            )
    ...
    async def _matrix_operation(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_operation(
                "matrix", func=args["func"], matrix=args["matrix"], other=args.get("other")
            )
    ...
    async def _vector_operation(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_operation(
                "vector", func=args["func"], vector=args["vector"], other=args.get("other")
            )
