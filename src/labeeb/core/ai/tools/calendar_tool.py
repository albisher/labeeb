...
class CalendarTool(BaseTool):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(
            name="calendar", description="Tool for performing calendar operations", config=config
        )
    ...
    async def _create_event(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"status": "success", "action": "create", "event_id": event_id, "event": event}

            self._add_to_history("create", {"event_id": event_id, "title": event["title"]})
    ...
    async def _read_event(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"status": "success", "action": "read", "event": self._events[event_id]}

            self._add_to_history("read", {"event_id": event_id})
    ...
    async def _update_event(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"status": "success", "action": "update", "event_id": event_id, "event": event}

            self._add_to_history("update", {"event_id": event_id, "title": event["title"]})
    ...
    async def _delete_event(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"status": "success", "action": "delete", "event_id": event_id}

            self._add_to_history("delete", {"event_id": event_id, "title": event["title"]})
    ...
    async def _search_events(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            for event in self._events.values():
                ...
                if (
                    query
                    and query not in event["title"].lower()
                    and query not in event["description"].lower()
                ):
                    continue
            ...
            result = {"status": "success", "action": "search", "events": matching_events}

            self._add_to_history("search", {"query": query, "result_count": len(matching_events)})
