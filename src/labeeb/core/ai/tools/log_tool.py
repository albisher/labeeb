...
class LogTool(BaseTool):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(
            name="log", description="Tool for performing logging operations", config=config
        )
    ...
    async def _log(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history("log", {"name": name, "level": level, "message": message})

            return {"status": "success", "action": "log", "name": name, "level": level}
        except Exception as e:
    ...
    async def _get_logs(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history("get_logs", {"name": name, "lines": len(lines)})

            return {"status": "success", "action": "get_logs", "name": name, "lines": lines}
        except Exception as e:
    ...
    async def _clear_logs(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history("clear_logs", {"name": name})

            return {"status": "success", "action": "clear_logs", "name": name}
        except Exception as e:
    ...
    async def _rotate_logs(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history("rotate_logs", {"name": name})

            return {"status": "success", "action": "rotate_logs", "name": name}
        except Exception as e:
