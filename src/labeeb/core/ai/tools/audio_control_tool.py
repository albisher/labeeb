...
class AudioControlTool(BaseTool):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            sd.check_input_settings(
                device=self._device, channels=self._channels, samplerate=self._sample_rate
            )
    ...
    async def _play_audio(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "action": "play", "file": file_path}
        except Exception as e:
    ...
    async def _record_audio(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._stream = sd.InputStream(
                samplerate=self._sample_rate, channels=self._channels, device=self._device
            )
            self._stream.start()
