...
class CommandHelp:
    ...
    COMMAND_HELP = {
        ...
        "curl": {
            ...
            "examples": ["curl https://example.com", "curl -o file.html https://example.com"],
            "categories": ["network"],
        },
        "networksetup": {
            "description": "macOS network configuration",
            "syntax": "networksetup [options]",
            "examples": ["networksetup -listallnetworkservices", "networksetup -getinfo Wi-Fi"],
        ...
        "system_profiler": {
            ...
            "examples": ["system_profiler SPHardwareDataType", "system_profiler SPNetworkDataType"],
