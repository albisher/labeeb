        ...
        try:
            if is_mac():
                try:
                    ...
                    raise ImportError(
                        "pyobjc CoreAudio not fully implemented, falling back to sounddevice."
                    )
                except Exception as e:
                    logger.info(
                        f"pyobjc CoreAudio not available or failed: {e}. Falling back to sounddevice."
                    )
    ...
    def get_audio_devices(self) -> Dict[str, Any]:
        ...
        if self.devices:
            ...
            return {
                "devices": [],
                "status": "unavailable",
                "message": "No audio devices found. Ensure permissions are granted and devices are connected.",
            }
    ...
    def get_input_devices(self) -> Dict[str, Any]:
        ...
        if inputs:
            ...
            return {
                "devices": [],
                "status": "unavailable",
                "message": "No input audio devices found.",
            }
    ...
    def get_output_devices(self) -> Dict[str, Any]:
        ...
        if outputs:
            ...
            return {
                "devices": [],
                "status": "unavailable",
                "message": "No output audio devices found.",
            }
