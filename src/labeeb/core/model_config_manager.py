...
class ModelConfigManager:
    ...
    def __init__(self, config_dir: Optional[str] = None):
        ...
        self.config_dir = config_dir or os.path.join(
            os.path.dirname(os.path.dirname(__file__)), "config", "models"
        )
    ...
    def update_optimization_settings(
        self, model_name: str, optimization_settings: Dict[str, Any]
    ) -> None:
        """
    ...
    def get_active_models(self) -> Dict[str, ModelConfig]:
        ...
        """
        return {name: config for name, config in self.configs.items() if config.is_active}
    ...
    def get_model_versions(self) -> Dict[str, str]:
        ...
        """
        return {name: config.version for name, config in self.configs.items()}
