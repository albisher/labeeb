...
class PlatformFactory:
    ...
    @classmethod
    def register_system_impl(
        cls, platform_name: str, implementation: Type[SystemInterface]
    ) -> None:
    ...
    @classmethod
    def register_network_impl(
        cls, platform_name: str, implementation: Type[NetworkInterface]
    ) -> None:
    ...
    @classmethod
    def register_fs_impl(
        cls, platform_name: str, implementation: Type[FileSystemInterface]
    ) -> None:
