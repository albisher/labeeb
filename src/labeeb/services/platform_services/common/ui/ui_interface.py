...
class UIInterface(ABC):
    ...
    def get_window_list(self) -> List[Dict[str, str]]:
        """Get list of open windows. All user-facing strings must be wrapped in translation functions (e.g., _())."""
        pass

    @abstractmethod
    def get_active_window(self) -> Dict[str, str]:
        """Get information about the active window. All user-facing strings must be wrapped in translation functions (e.g., _())."""
        pass
    ...
    def type_text(self, text: str) -> bool:
        """Type text using keyboard. All user-facing strings must be wrapped in translation functions (e.g., _())."""
        pass

    @abstractmethod
    def press_key(self, key: str) -> bool:
        """Press a specific key. All user-facing strings must be wrapped in translation functions (e.g., _())."""
        pass
