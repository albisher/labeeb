...
class LinuxUIHandler(BaseUIHandler):
    ...
    def get_window_list(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            window_ids = root.get_full_property(
                self._display.intern_atom("_NET_CLIENT_LIST"), Xlib.X.AnyPropertyType
            ).value
    ...
    def get_active_window(self) -> Dict[str, Any]:
        ...
        try:
            ...
            active_window = root.get_full_property(
                self._display.intern_atom("_NET_ACTIVE_WINDOW"), Xlib.X.AnyPropertyType
            ).value[0]
    ...
    def set_clipboard_content(self, content: str) -> bool:
        ...
        try:
            ...
            subprocess.run(
                ["xclip", "-i", "-selection", "clipboard"], input=content.encode(), check=True
            )
            return True
        except Exception as e:
