...
class SystemInfoHealthCheck:
    """
    Service for checking and reporting the health status of the system (CPU, memory, disk, network).

    - Single responsibility: system health check and reporting.
    - Inputs: none (uses system state).
    - Outputs: dicts with health status and system info.
