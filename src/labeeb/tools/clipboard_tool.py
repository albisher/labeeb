...
class ClipboardTool(BaseTool):
    ...
    def get_command_help(self, command: str) -> Dict[str, Any]:
        ...
        help_info = {
            "set_text": {
                ...
                "args": {"text": "Text content to set"},
            },
            "get_text": {"description": "Get text content from clipboard", "args": {}},
            "set_html": {
                "description": "Set HTML content in clipboard",
                "args": {"html": "HTML content to set"},
            },
            "get_html": {"description": "Get HTML content from clipboard", "args": {}},
            "set_rtf": {
                "description": "Set RTF content in clipboard",
                "args": {"rtf": "RTF content to set"},
            },
            "get_rtf": {"description": "Get RTF content from clipboard", "args": {}},
            "set_image": {
                "description": "Set image content in clipboard",
                "args": {"image_data": "Image data in bytes"},
            },
            "get_image": {"description": "Get image content from clipboard", "args": {}},
            "set_files": {
                "description": "Set file list in clipboard",
                "args": {"files": "List of file paths"},
            },
            "get_files": {"description": "Get file list from clipboard", "args": {}},
            "clear": {"description": "Clear clipboard contents", "args": {}},
            "get_formats": {"description": "Get available clipboard formats", "args": {}},
        }
    ...
    def _set_text(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "action": "set_text", "length": len(text)}
        except Exception as e:
    ...
    def _set_html(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "action": "set_html", "length": len(html)}
        except Exception as e:
    ...
    def _set_rtf(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "action": "set_rtf", "length": len(rtf)}
        except Exception as e:
