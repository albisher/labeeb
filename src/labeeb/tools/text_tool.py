...
class TextTool(BaseTool):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self._allowed_languages = config.get(
    ...
    async def _process_text(self, text: str, operation: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self._cache[cache_key] = {
                "data": {"status": "success", "action": operation, "result": processed_data},
                "timestamp": time.time(),
            }
    ...
    async def _clean_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "clean")

            if "error" not in result:
                self._add_to_history("clean", {"length": len(result["result"])})
    ...
    async def _normalize_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "normalize")

            if "error" not in result:
                self._add_to_history("normalize", {"length": len(result["result"])})
    ...
    async def _tokenize_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "tokenize")

            if "error" not in result:
                self._add_to_history("tokenize", {"token_count": len(result["result"])})
    ...
    async def _detect_language(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "detect_language")

            if "error" not in result:
                self._add_to_history("detect_language", {"language": result["result"]})
    ...
    async def _translate_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(
                args["text"], "translate", target_language=args["target_language"]
            )

            if "error" not in result:
                self._add_to_history(
                    "translate",
                    {"target_language": args["target_language"], "length": len(result["result"])},
                )
    ...
    async def _summarize_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "summarize")

            if "error" not in result:
                self._add_to_history("summarize", {"length": len(result["result"])})
    ...
    async def _extract_keywords(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._process_text(args["text"], "extract_keywords")

            if "error" not in result:
                self._add_to_history("extract_keywords", {"keyword_count": len(result["result"])})
