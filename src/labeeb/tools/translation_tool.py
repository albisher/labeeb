...
class TranslationTool(BaseTool):
    ...
    def get_capabilities(self) -> Dict[str, bool]:
        ...
        tool_capabilities = {"translate": True, "detect": True, "languages": True, "history": True}
    ...
    async def _translate_text(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history(
                "translate", {"source": source, "target": target, "text_length": len(text)}
            )
    ...
    async def _detect_language(self, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._add_to_history("detect", {"text_length": len(text)})
    ...
    async def _get_supported_languages(
        ...
        try:
            ...
            self._add_to_history("languages", {"target": target})
